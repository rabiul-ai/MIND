...
code_outputs = 'code outputs/c6 text pred 3 ClinicalBERT'
...
# Tokenize and embed with Bio_ClinicalBERT
...
# Save to CSV
results_df.to_csv(f"{code_outputs}/Bio_ClinicalBERT_prediction_{n_nodule}.csv", index=False, encoding='utf-8-sig')
