...
code_outputs = 'code outputs/c3 text pred 1 BioBERT'
n_nodule = 955 
...
# Tokenize and embed with BioBERT
...
# Save to CSV
results_df.to_csv(f"{code_outputs}/BioBERT_prediction_{n_nodule}.csv", index=False, encoding='utf-8-sig')
